...
var musicaAleatoria = Math.floor(Math.random() * musicas.length)

lofi.src = musicas[musicaAleatoria]
...
function iniciar() {
   ...
   if (acao.value == 0 || acao.value < 1) {
      document.getElementById('erro_acao').innerHTML = "Adicione os minutos corretos"
      acao.focus()
   } else if (pausa.value == 0 || acao.value < 1) {
      document.getElementById('erro_pausa').innerHTML = "Adicione a pausa correta"
      pausa.focus()
   } else if (sessoes.value == 0 || acao.value < 1) {
      document.getElementById('erro_sessoes').innerHTML = "Adicione as sessões corretas"
      sessoes.focus()
   } else {
